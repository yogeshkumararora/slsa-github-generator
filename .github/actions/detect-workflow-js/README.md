...
myjob:
  ...
  uses: yogeshkumararora/slsa-github-generator/.github/workflows/generator_generic_slsa3.yml@<tag>
  with:
  ...
  detect-workflow:
    ...
    steps:
      - name: Detect the repository and ref
        id: detect
        uses: yogeshkumararora/slsa-github-generator/.github/actions/detect-workflow-js@<git hash>
