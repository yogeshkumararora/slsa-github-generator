...
const DELEGATOR_BUILD_TYPE_V0 =
  "https://github.com/yogeshkumararora/slsa-github-generator/delegator-generic@v0";
...
export async function createPredicate(
  ...
  const predicate: SLSAPredicate = {
    ...
    runDetails: {
      // TODO(https://github.com/yogeshkumararora/slsa-github-generator/issues/1504):
  ...
  // TODO(github.com/yogeshkumararora/slsa-github-generator/issues/1575): Redact sensitive information.
