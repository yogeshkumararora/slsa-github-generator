...
[Node.js Builder GA milestone](https://github.com/yogeshkumararora/slsa-github-generator/milestone/17).
  ...
  publish:
    ...
    steps:
      ...
      - name: Download tarball
        uses: yogeshkumararora/slsa-github-generator/actions/nodejs/secure-package-download@v2.0.0
        with:
      ...
      - name: Download provenance
        uses: yogeshkumararora/slsa-github-generator/actions/nodejs/secure-attestations-download@v2.0.0
        with:
...
| Name                         | Value                                                                                                                  | Description                                                                                                                                                                                                            |
| ---------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `builder.id`                 | `https://github.com/yogeshkumararora/slsa-github-generator/.github/workflows/builder_nodejs_slsa3.yml@refs/tags/v1.5.0"` | Identifies the Node.js builder                                                                                                                                                                                         |
| `buildType`                  | `"https://github.com/yogeshkumararora/slsa-github-generator/delegator-generic@v0"`                                       | Identifies a the GitHub Actions build.                                                                                                                                                                                 |
...
```json
{
  ...
  "predicate": {
    "builder": {
      "id": "https://github.com/yogeshkumararora/slsa-github-generator/.github/workflows/builder_nodejs_slsa3.yml@refs/tags/v1.5.0"
    },
    "buildType": "https://github.com/yogeshkumararora/slsa-github-generator/delegator-generic@v0",
    "invocation": {
      "configSource": {
...
release. See
[#1789](https://github.com/yogeshkumararora/slsa-github-generator/issues/1789) for
more details.
